        ...
        <div className="bg-suco-plum/8 p-5 border-b border-suco-plum/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Category + difficulty tags for API / Spotify questions */}
              {(question.source === "api" || question.source === "spotify") && (
                <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                  {/* Spotify badge */}
                  {question.source === "spotify" && (
                    <span className="text-[10px] bg-[#1DB954]/15 text-[#1DB954] border border-[#1DB954]/30 rounded-full px-2 py-0.5 font-bold flex items-center gap-1">
                  ...
                  {question.category && question.source !== "spotify" && (
